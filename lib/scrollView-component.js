...
export default class ScrollViewComponent extends cc.ScriptComponent {
  ...
  onEnable() {
    ...
    this._moveArea.on('touchmove', this._onTouchMove);
    this._moveArea.on('touchend', this._onTouchEnd);
  }
  ...
  onDisable() {
    ...
    this._moveArea.off('touchmove', this._onTouchMove);
    this._moveArea.off('touchend', this._onTouchEnd);
  }
