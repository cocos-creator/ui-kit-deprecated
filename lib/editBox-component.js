...
export default class EditBoxComponent extends ButtonComponent {
  constructor() {
    ...
    this._onMouseUp = (e) => {
      ...
      if (e.button === 'left') {
        if (widgetSys.focusedEntity !== this._textComp._entity) {
          return;
        }
    ...
    this._onEditBoxClk = (e) => {
      ...
      e.stop();
      if (
        widgetSys.focusedEntity !== this._textComp._entity &&
  ...
  onEnable() {
    ...
    this._textComp._entity.on('touchend', this._onEditBoxClk);
    this._entity.on('touchend', this._onEditBoxClk);
    this._otherArea.on('touchend', this._onTouchOther);
  }
  ...
  onDisable() {
    ...
    this._textComp._entity.off('touchstart', this._onEditBoxTouchStart);
    this._textComp._entity.off('touchend', this._onMouseUp);
    this._entity.off('touchend', this._onMouseUp);
    this._otherArea.off('touchend', this._onTouchOther);
  }
